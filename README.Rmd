...
**Acknowledgment:** This assignment is inspired by softmax classifier assignment in [CS231n](https://cs231n.github.io/). 
...
In machine learning literature, it is common to call $f(\beta)$ the **softmax** loss. It depends on the supplied training data \(X\in \mathbb{R}^{n\times p}\) (with
...
- one pass (forward and backward), use $\lambda = 0$ in forward pass, and directly incorporate $\lambda$ into gradient for backward pass
 ...
 * correctness of functions _(45% of the grade)_
 ...
 * playing with parameters on letter example to get better error _(5% of the grade)_
